...
var ConfigWikiCategoryComponent = (function () {
    ...
    function ConfigWikiCategoryComponent(route, router, configWikiService, adminMainService) {
        ...
        this.selectedConfigWikiCategories = [];
    }
    /**
     * OnInit method.
     */
     ...
     * Navigate.
     */
    ConfigWikiCategoryComponent.prototype.buttonNavigateEditCategory = function () {
        if (this.selectedConfigWikiCategories.length > 0) {
            var idCategoryToNavigateTo = this.selectedConfigWikiCategories[0]._id;
