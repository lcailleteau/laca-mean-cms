...
var LacaAuthenticationService = (function () {
    ...
    */
     ...
     * Login method.
     */
    LacaAuthenticationService.prototype.cailleteau = function () {
        console.log("from laca authenticatio nservice CAILLETEAU ");
        console.log("from laca authenticatio nservice CAILLETEAU " + this.adminMainService);
    };
    /**
     * Login method.
     */
    ...
    LacaAuthenticationService.prototype.extractData2 = function (jsonResponse) {
        ...
        console.log("from laca authenticatio nservice ADMIN MAI NSVC ---888" + this.cailleteau());
...
//# sourceMappingURL=laca-authentication.service.js.map