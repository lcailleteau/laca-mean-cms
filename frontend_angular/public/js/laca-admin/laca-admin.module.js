...
var laca_ckeditor_component_1 = require("./_components/laca-ckeditor/laca-ckeditor.component");
...
LacaAdminModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [
            ...
            config_wiki_category_detail_edit_component_1.ConfigWikiCategoryDetailEditComponent,
            ...
            config_wiki_article_detail_edit_component_1.ConfigWikiArticleDetailEditComponent,
            ...
            laca_ckeditor_component_1.LacaCKEditorComponent
        ],
        providers: [
